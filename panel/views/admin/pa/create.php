    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                ...
                <div class="col-auto">
                    <a href="<?php echo Url::getBase() . 'pa/' ?>" class="btn btn-md btn-dark float-right">
                        <i class="fa fa-list"></i> Listar PA
                    </a>
                </div>
            </div>
            <div class="card-body">
                ...
                <form method="post" action="" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            ...
                            <select disabled name="tipo_user" required class="form-control" data-toggle="select" data-minimum-results-for-search="-1">
                                <option value="">SELECIONE</option>
                                <option value="4" selected data-avatar-src="<?php echo Url::getBase() ?>../assets/img/icons/master.png">Ponto de Apoio *PA</option>
                            </select>
                        </div>
                    </div>
                    <!--endereço-->
                    ...
                    <button class="btn btn-dark" type="submit" id="x"><i class="fa fa-save"></i> Finalizar cadastro do PA</button>
                </form>
            </div>
        </div>
    </div>
