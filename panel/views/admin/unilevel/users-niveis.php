...
data-lists-values='["tables-row", "tables-user", "tables-valor", "tables-data"]'>
    ...
    <tbody class="list">
        ...
        <tr>
            ...
            <td class="tables-valor"><i class="fa fa-user"></i> <?php echo $total ?></td>
            <td class="tables-data"><span class="badge badge-success"><i class="fa fa-money-check-alt"></i> R$ <?php echo $comissao ?></span></td>
        </tr>
        <?php } ?>
        <tr scope="col">
            <th colspan="2">TOTAL</th>
            <th colspan="1"><span class="badge badge-info"><i class="fa fa-money-check-alt"></i> R$ <?php echo number_format($totalComissao, 2, ",", "") ?></span></th>
        </tr>
    </tbody>
    </table>
</div>