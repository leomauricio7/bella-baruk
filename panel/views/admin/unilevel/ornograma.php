            ...
            <li id="afiliados_<?php echo $_SESSION['idUser'] ?>">
                ...
                ?>	
                    <li id="afiliados_<?php echo $id ?>">
                        <a href="#md-InfoAfiliado" id="<?php echo $id ?>" class="btDetalhe" data-toggle="modal" data-target="#md-InfoAfiliado" style="width: 70px !important; height: auto !important; padding-top: 15px;">
