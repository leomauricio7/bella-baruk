      ...
      <div class="row justify-content-center">
        <div class="col-12 col-lg-10 col-xl-8">
          ...
          if ($_POST) {
            ...
            if (Validation::check_white_space($dados["slug"])) {
              echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
              <strong>Error!</strong> Login informado é invalido! Atenda os requisitos para ciar um login valido.
            ...
            <div class="row">
              <div class="col-12 col-md-6 order-md-2">
                <div class="card bg-light border ml-md-4">
                  <div class="card-body">
                    <p class="mb-2">
                      Requisitos para criar o login
                    </p>
                    <p class="small text-muted mb-2">
                      Para criar seu login, você deve seguir essas observações:
                    </p>
                    <ul class="small text-muted pl-4 mb-0">
                      <li>Minimo 4 caracteres</li>
                      <li>Somente caracteres minusculos</li>
                      <li>Sem espaço</li>
                      <li>Sem caracteres especiais. Ex: áãÂç</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="col-12 col-md-6">
                ...
                <div class="form-group">
                  <label>Login</label>
                  <input type="text" name="slug" class="form-control" id="name-login" required>
                </div>
              </div>
            </div>
            <div class="row">
